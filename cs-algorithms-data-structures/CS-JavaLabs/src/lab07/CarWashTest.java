...
public class CarWashTest extends CarWash
{
    ...
    {
        carWash.process (5, currentTime);
        results = carWash.process (3, currentTime);        
    ...
    {  
        carWash.process (5, currentTime);
        carWash.process (7, currentTime);
        carWash.process (8, currentTime);
        carWash.process (12, currentTime);
        carWash.process (12, currentTime);          
        assertTrue (carWash.process (13, currentTime).toString().
                    indexOf (CarWash.OVERFLOW) == -1); // no overflow for arrival at 13       
        assertTrue (carWash.process (14, currentTime).toString().
                    indexOf (CarWash.OVERFLOW) > 0);   // overflow for arrival at 14 
    } // method overflowTest
    ...
    {   
        ...
        carWash.process (12, currentTime);
        carWash.process (12, currentTime);
        carWash.process (13, currentTime);        
        results = carWash.process (15, currentTime);  
