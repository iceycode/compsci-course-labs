...
/** RULES - IMPORTANT for QUEUES! (front in/out)
...
public class CarWash
{
     ...
     * --CarWash is it's own entity - essentially a station, but only one station
     *  
     * 
     */
     public CarWash()
     ...
     *  car queue). At most can have just 5, 6 if one is departing at right time
     *
