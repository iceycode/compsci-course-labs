...
public class LottoGUI extends JFrame {
	...
	private Numbers n; //the numbers user picks
	...
	public void clickedNumber(JButton button, int clickedAmt){
		...
		if (numCount < 6){
			if (clickedAmt%2 == 0){
				...
				Integer num1 = Integer.valueOf(button.getText()); 
...
//*************SwingAction classes
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			new Numbers().winningNums();
			setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		}
	}
	
	private class DrawNumbers extends AbstractAction{
